...
const APPS = [
  ...
  { id: 'settings', name: 'Settings', icon: Settings, color: '#64748b', cat: 'System' },
  { id: 'monitor', name: 'System Monitor', icon: BarChart3, color: '#22c55e', cat: 'System' },
  { id: 'security', name: 'Security Vault', icon: Lock, color: '#f59e0b', cat: 'System' },
  { id: 'cloud', name: 'Cloud Sync', icon: Cloud, color: '#0ea5e9', cat: 'System' },
  { id: 'network', name: 'Network Hub', icon: Wifi, color: '#a855f7', cat: 'System' },
  { id: 'storage', name: 'Memory Drive', icon: Database, color: '#00f5ff', cat: 'System' },
  { id: 'firewall', name: 'Firewall', icon: Shield, color: '#ef4444', cat: 'System' },

  // AI
  { id: 'nexus', name: 'NEXUS Core', icon: Brain, color: '#a855f7', cat: 'AI' },
  { id: 'vision', name: 'AI Vision', icon: Camera, color: '#ec4899', cat: 'AI' },
  { id: 'neural', name: 'Neural Lab', icon: Cpu, color: '#00f5ff', cat: 'AI' },
  { id: 'coder', name: 'Code Synthesizer', icon: Code, color: '#22c55e', cat: 'AI' },

  // Media
  { id: 'music', name: 'Spotify', icon: Music, color: '#1db954', cat: 'Media' },
  { id: 'video', name: 'HoloView', icon: Video, color: '#f59e0b', cat: 'Media' },
  { id: 'files', name: 'Files', icon: FileText, color: '#0ea5e9', cat: 'Media' },
  { id: 'browser', name: 'Holoweb', icon: Globe, color: '#00f5ff', cat: 'Media' },

  // Communications
  { id: 'mail', name: 'Comms Mail', icon: Mail, color: '#00f5ff', cat: 'Comms' },
  { id: 'call', name: 'Holocall', icon: Phone, color: '#22c55e', cat: 'Comms' },
  { id: 'maps', name: 'Spatial Map', icon: Map, color: '#a855f7', cat: 'Comms' },
  { id: 'packages', name: 'Node Registry', icon: Package, color: '#0ea5e9', cat: 'Comms' },
