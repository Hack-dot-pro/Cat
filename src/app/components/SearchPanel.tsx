...
const MOCK_RESULTS: Record<string, { title: string; snippet: string; source: string; type: string }[]> = {
  default: [
    { title: 'CAT AI Documentation v3.7', snippet: 'Complete reference manual for CAT AI OS. Voice commands, gesture controls, API integration, memory management.', source: 'cat.ai/docs', type: 'doc' },
  ...
  ai: [
    ...
    { title: 'CAT Neural Core Architecture', snippet: 'Inside look at the modular design of CAT. Distributed inference across 48 neural processing units.', source: 'cat.ai/blog', type: 'doc' },
  ],
};
